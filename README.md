...
<p align="center">
<img alt="GitHub release (latest by date)" src="https://img.shields.io/github/v/release/ipmartnetwork/iPmart-Bot-Panel">
</p>
...
- برای اوبنتوی 20 به بالاتر قبل از وارد کردن دستور اسکریپت کد زیر را وارد کنید
```bash
