...
# install more !
echo 'phpmyadmin phpmyadmin/app-password-confirm password iPmartBotPanel' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/reconfigure-webserver multiselect apache2' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/mysql/admin-pass password iPmartBotPanel' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/mysql/app-pass password iPmartBotPanel' | debconf-set-selections
...
dbname="iPmartPanel_${randdbpass}"
...
config_address="/var/www/html/iPmartBotPanel/install/iPmart.install"
...
curl --location "https://${DOMAIN}/iPmartBotPanel/sql/sql.php?db_password=${dbpass}&db_name=${dbname}&db_username=${dbuser}"
...
sleep 1
colorized_echo green "[+] The iPmart Panel Bot Has Been Successfully Installed"
colorized_echo green "[+] Telegram channel: @ipmartpanel || Telegram group: @iPmartNetwork_GP"
echo -e "\n"
