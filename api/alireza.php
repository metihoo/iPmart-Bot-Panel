...
class Sanayi{
    ...
    public function checkId($inbound_id) {
        $url = $this->base_url . '/xui/inbound/list';
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => $url,
          CURLOPT_RETURNTRANSFER => true,
    ...
    public function getSubPort() {
        $url = $this->base_url . '/xui/setting/all';
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => $url,
          CURLOPT_RETURNTRANSFER => true,
    ...
    public function addClient($name, $id, $date, $limit){
        ...
        $url = $this->base_url . '/xui/inbound/addClient';
    ...
    public function addExpire($remark, $date, $id) {
        ...
        $update_url = $this->base_url . '/xui/inbound/updateClient/' . $uuid;
